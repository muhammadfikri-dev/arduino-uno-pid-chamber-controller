/**
 * =========================================================================================
 * Project     : Arduino Uno High-Precision PID Environmental Test Chamber
 * Platform    : Arduino Uno / ATmega328P
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : Industrial thermal chamber climate controller utilizing PID algorithm with anti-windup, PT100 RTD MAX31865 4-wire temperature acquisition, SSR zero-cross PWM heating, and Peltier cooling.
 * =========================================================================================
 */
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" Arduino Uno High-Precision PID Environmental Test Chamber"));
